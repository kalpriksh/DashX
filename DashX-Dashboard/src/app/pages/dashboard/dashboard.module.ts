...
@NgModule({
  declarations: [OptionSelectorComponent, LineChartComponent, PieChartComponent, ChartsContainerComponent, BarGraphComponent, ChartEditorComponent, ChartSetupComponent, ReadExcelDirective],
